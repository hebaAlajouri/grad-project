...
<style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn-save {
        margin-top: 28px; padding: 13px 32px; background: var(--dark);
    ...
    .btn-save:hover { background: var(--coffee); }
 
    .image-preview-wrap { margin-top: 10px; }
    .image-preview { width: 100px; height: 100px; object-fit: cover; border-radius: 3px; border: 1px solid var(--sand); }
</style>
@endpush
        ...
        <div class="form-grid">
            ...
            <div class="form-group form-full">
                ...
                <input type="text" name="name" class="form-control"
                       value="{{ old('name') }}" placeholder="e.g. Rose Candle">
            ...
            <div class="form-group">
                ...
                @error('stock_status') <div class="field-error">{{ $message }}</div> @enderror
            </div>
